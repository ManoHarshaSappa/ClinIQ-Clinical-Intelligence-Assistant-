  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 border border-blue-200">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900">MCP Clinical Intelligence</h2>
          <p className="text-sm text-slate-600">Enhanced clinical decision support powered by Model Context Protocol</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {activeFeatures.map((feature) => (
          <div key={feature.id} className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm hover:shadow-md transition-all">
      ...
      <div className="mt-6 bg-white rounded-xl p-4 border border-slate-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div className="space-y-1">
            <div className="text-lg font-bold text-blue-600">2.1ms</div>
          ...
          <div className="space-y-1">
            <div className="text-lg font-bold text-amber-600">Real-time</div>
