    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl font-bold text-slate-900">Drug Checker</h1>
        </div>
        ...
        <>
          <Card className="p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">Compare Drug Interactions</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g., Furosemide, Warfarin, Insulin"
                  className="w-full"
                />
              </div>
            </div>
          ...
          {/* Interaction Results */}
          {interactionResult && (
            <Card className={`p-6 border-2 ${getSeverityColor(interactionResult.severity)} mb-8`}>
          ...
          {/* Quick Examples */}
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Common Drug Interaction Checks</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <button
                  ...
                  className="text-left p-4 bg-white border border-slate-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-colors"
                >
                  <div className="text-sm font-medium text-slate-900">{d1} + {d2}</div>
                  <div className="text-xs text-slate-500 mt-1">Click to check</div>
                </button>
              ))}
            </div>
          </div>
        ...
        <>
          <Card className="p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">Ask About Drugs</h2>
            </div>
            ...
            <div className="mb-4">
              ...
              <Input
                ...
                placeholder="e.g., What is the mechanism of action of Metformin? What are the side effects of Lisinopril?"
                className="w-full"
          ...
          {/* Information Results */}
          {infoResult && (
            <Card className="p-6 border-2 border-blue-200 bg-blue-50 mb-8">
              <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {infoResult.sources.map((source, index) => (
                          <li key={index} className="text-xs text-slate-600 bg-white p-2 rounded border">
                            {source}
                          </li>
                        ))}
                      </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <div className="text-xs text-slate-500 mt-1">Click to ask</div>
                </button>
              ))}
            </div>
          </div>
